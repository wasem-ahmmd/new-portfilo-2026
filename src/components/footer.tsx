          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-xl font-bold tracking-tight">Wasim</span>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Founder of Eznah AI & Dev — building beautiful digital experiences with purpose and precision.
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-sm font-semibold tracking-[0.2em] uppercase text-gray-500 mb-4">
                Quick Links
              </h4>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400">
                    Mendhar, Poonch, Jammu & Kashmir, India
                  </span>
                </li>
              </ul>
            </div>
